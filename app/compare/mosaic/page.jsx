export const metadata = {
  title: "FinanceOS vs Mosaic — FP&A Platform Comparison 2026",
  description: "Compare FinanceOS and Pigment for financial planning. FinanceOS starts at $499/mo with AI copilot and 48-hour setup. Pigment starts at $50K+/year with longer implementation cycles.",
  keywords: ["FinanceOS vs Mosaic", "Mosaic alternative", "FP&A software comparison", "Mosaic pricing", "best FP&A platform 2026"],
  openGraph: { title: "FinanceOS vs Mosaic — FP&A Comparison 2026", url: "https://finance-os.app/compare/mosaic" },
  alternates: { canonical: "https://finance-os.app/compare/mosaic" },
};

export default function CompareMosaic() {
  const rows = [
    { feature: "Starting Price", fos: "$499/month", competitor: "$50K+/year", winner: "fos" },
    { feature: "Implementation Time", fos: "Under 48 hours", competitor: "6–12 weeks", winner: "fos" },
    ...
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: "#0a0e1a", color: "#c8cdd8", minHeight: "100vh" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "60px 24px" }}>
        <nav style={{ fontSize: 12, color: "#5a6178", marginBottom: 32 }}>
          ...
          <span style={{ margin: "0 8px" }}>/</span><span style={{ color: "#c8cdd8" }}>Mosaic</span>
        </nav>

        <h1 style={{ fontSize: 36, fontWeight: 800, color: "#f0f2f7", lineHeight: 1.2, marginBottom: 16 }}>FinanceOS vs Mosaic: FP&A Platform Comparison</h1>
        <p style={{ fontSize: 16, lineHeight: 1.7, color: "#9ea5b8", marginBottom: 40, maxWidth: 700 }}>
          FinanceOS is an AI-native FP&A platform starting at $499/month that deploys in under 48 hours. Pigment is a business planning platform starting at $50K+/year with typical 4–12 week implementations. Both offer strong scenario modeling and consolidation, but FinanceOS adds AI-powered natural language querying and ML-based forecasting at a fraction of the price.
        </p>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ background: "#111827" }}>
                ...
                <th style={{ padding: "14px 20px", textAlign: "left", fontSize: 12, fontWeight: 700, color: "#5a6178", textTransform: "uppercase", letterSpacing: "0.08em", borderBottom: "2px solid #1e2230" }}>Mosaic</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r, i) => (
        ...
        <div style={{ textAlign: "center", padding: "48px 0", borderTop: "1px solid #1e2230" }}>
          ...
          <a href="/?ref=compare-mosaic" style={{ display: "inline-block", padding: "14px 32px", borderRadius: 10, background: "linear-gradient(135deg, #60a5fa, #a78bfa)", color: "#fff", fontWeight: 700, fontSize: 14, textDecoration: "none" }}>Try FinanceOS Free</a>
        </div>
